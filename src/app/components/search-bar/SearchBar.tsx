            ...
            <Row>
                <Form className="col-8 col-md-6">
                    <Form.Group className="d-flex align-items-center h-100">
                        <Form.Control className="w-50 me-2" type="text" name="buscar" placeholder="Buscar" value={search}
                ...
                <div className="col-4 col-md-6 d-flex justify-content-end">
                    <Link className="btn d-flex flex-column align-items-center justify-content-center" to="adicionar">
