            ...
            <main id="medication">
                ...
                <Container>
                    ...
                    <Row className="summary mb-5 p-2">
                        ...
                        <span><b>Nome referência: </b>{medication.nome_referencia}</span>
                        ...
                        <span><b>Vencimento do registro: </b>{new Date(medication.vencimento_registro).toLocaleDateString()}</span>
                    </Row>
                </Container>
            </main>
        </Layouts.RestrictedLayout>
