        ...
        <>
            <Row>
                ...
                <Form.Group className="mb-3 col-lg-6">
                    ...
                    <Form.Control type="number" step="0.01" name="quantidade" id="quantidade"
                                  defaultValue={data?.quantidade} min={0} required/>
                    <Form.Text className="text-danger">{validationErrors["quantidade"] ?? ""}</Form.Text>
                </Form.Group>

                <Form.Group className="mb-3 col-lg-6">
                    <Form.Label htmlFor="medida">Medida*</Form.Label>
                    <Form.Control name="medida" id="medida" defaultValue={data?.medida} maxLength={255}
                                  placeholder="ex: comprimido, capsula, ml" required/>
